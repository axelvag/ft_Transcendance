...
<body class="bg-primary d-flex align-items-center justify-content-center vh-100">
    ...
    :root {
        --bs-primary: #a75abe;
        --bs-primary-rgb: 167, 90, 190;     /* background color in rgb */
    }
    .btn {
        --bs-btn-bg: #a75abe;   /* Connexion botom */
    }
    </style>
    <div class="container-fluid" style="max-width: 400px">
        <div class="card card-white">
            <div class="card-body">
                <h5 class="card-title py-2 mb-3 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="height: 1em; vertical-align: -0.25em;" class="me-1" >
...
To change the background color which is blue by default with BootStrap, I had to modify the variables at the root like this:
...
For a small user icon in svg, I put his code in raw form but David
subsequently made a class in js to load them in shadow and thus
call them more neatly and simply:
