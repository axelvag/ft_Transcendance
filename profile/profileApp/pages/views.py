...
def verif_sessionID(view_func):
    def wrapper(request, *args, **kwargs):
        ...
        try:
            ...
            return JsonResponse({"success": False, "message": "Network Error"}, status=500)
...
def update_user(request):
    ...
    # maj or creation profil user in bdd
    try:
        defaults = {
        ...
        # if nothing profile existing and nothing avatar
